...
1. **Fetch RFE** - Retrieve the RFE from Jira via REST API
...
- **Quick Checklist**: [skills/analyze-rfe/PREREQUISITES.md](../skills/analyze-rfe/PREREQUISITES.md)
- **Detailed Setup Guide**: [skills/analyze-rfe/SETUP.md](../skills/analyze-rfe/SETUP.md)
